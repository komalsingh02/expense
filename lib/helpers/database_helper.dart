...
class DatabaseHelper {
  ...
  _initDatabase() async {
    ...
    Database x= await openDatabase(path,
  ...
  Future updateTransaction(txn.Transaction tx)async{
    Database db = await database;
    await db.update(tableTransactions, tx.toMap(),where: "id = ?",whereArgs: [tx.txnId]);
  }
}
